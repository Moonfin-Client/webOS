...
var JellyseerrAPI = (function() {
    ...
    /**
     * Luna service communication for Node.js proxy
     * Handles cookie management outside browser Same-Origin Policy
     */
    const LunaServiceBridge = {
        ...
        /**
         * Make HTTP request through Luna service
         */
        ...
        clearCookies: function(domain) {
            return new Promise(function(resolve, reject) {
                ...
                webOS.service.request('luna://org.moonfin.webos.service/', {
                    method: 'jellyseerrClearCookies',
                    parameters: {
                        userId: currentUserId,
                        domain: domain
                    },
                    onSuccess: function() {
                        Logger.info('Cookies cleared via service');
                        resolve();
                    },
                    onFailure: function(error) {
                        Logger.warn('Failed to clear cookies via service:', error.errorText);
